...
public final class DialogueSender {
    ...
    public static void sendHomeWizardDialogue(Player player) {
        player
            .sendDialogue(new Dialogue(
                player,
                new NpcDialogueAction(
                    460,
                    "Hello " + player.getCapitalizedUsername() + "! This is the new dialogue system!",
                ...
                new GiveItemDialogueAction(new Item(995, 1000),
                    "The wizard hands you 1000 coins."),
